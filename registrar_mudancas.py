...
def carregar_buffer():
    ...
    if os.path.exists(PERSISTENT_FILE):
        try:
            ...
            #change logging
            novo_step_log("carregar_buffer", "Sucesso", "Buffer carregado do disco.")
            print("Buffer carregado do disco.")
        except Exception as e:
            print("Erro ao carregar buffer:", e)
            novo_step_log("carregar_buffer", "Falha", str(e))
...
def salvar_buffer_em_disco():
    try:
        ...
        novo_step_log("salvar_buffer_em_disco", "Sucesso", change_buffer)
    except Exception as e:
        print("Erro ao salvar buffer no disco:", e)
        novo_step_log("salvar_buffer_em_disco", "Falha", str(e))
